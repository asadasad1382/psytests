...
<head>
    ...
    <meta name="description"
          content="{{\App\Models\Setting::get('title')}}">
    <meta name="keywords"
          content="{{\App\Models\Setting::get('title')}}">
                    ...
                    <a class="nav-link dropdown-toggle dropdown-user-link"
                       ...
                       aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none text-start">
                            <span
                                class="user-name fw-bolder">{{Auth::guard('admin')->user()->name}}</span>
                            <span
                                class="user-status">مدیر</span>
                        </div>
                        <span class="avatar">
                        <img class="round"
                             src="/admin/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar"
                             height="40" width="40">
                        <span
